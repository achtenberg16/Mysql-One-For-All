...
INSERT INTO
  SpotifyClone.users (user_nome, idade, plano_id, data_assinatura)
VALUES
  ...
  INSERT INTO SpotifyClone.seguindo_artista (user_id, artista_id)
  VALUES (1,1),
  (1,4),
  (1,3),
  (2,1),
  ...
  INSERT INTO
  SpotifyClone.musicas (musica_nome, album_id, duracao_sec)
VALUES
  ('Soul For Us', 1, 200),
...
INSERT INTO
  SpotifyClone.historico_reproducoes (user_id, musica_id, data_reproducao)
VALUES
